...
class UserProfileForm(forms.ModelForm):
    ...
    # one way to make the fields read only
    ...
    class Meta:
        model = UserProfile
        fields = [
            'profile_picture', 'cover_photo', 'address', 'country', 'state', 'city', 'pin_code', 'latitude', 'longitude'
        ]

    # another way to make the fields read only
